...
<body>
    <h2 style="color: white">Displaying Customer's Records</h2>
<style>
    body{
...
String QueryString = "SELECT * from Cdetails";
rs = statement.executeQuery(QueryString);
%>
<TABLE cellpadding="15" border="1" style="color: red ; background-color: black">
<%
while (rs.next()) {
%>
<TR>
